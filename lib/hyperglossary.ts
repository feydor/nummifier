...
const TheGlossary = [
    ...
    "heart of darkness", "doctor faustus", "chainlink", "qwertynomics", "new world order", "hollow earth theory", "empty internet theory",
    "few understand this", "pizzapizzagate", "atheognosticism", "bogdanov dump", "outsideness", "austrialian fingernail harvest",
    ...
    "ghost in the shell", "xenosytem", "the fire rises", "rationalist movement", "slate star codex", "eliezer yudkowsky", "nick szabo",
    ...
    "distributed ledger", "central bank digital currency", "primitive accumulation", "hyperstition", "hyperstition in action",
    "all conspiracies are true", "distributed conspiracy", "involvments with reality", "scott alexander", "the queen of hearts she made some tarts",
    ...
    "exoteric religion", "immanentize the eschaton", "dont immanentize the eschaton", "there is no alternative", "the unbanked",
    "monadology", "preestablishedharmony", "bestofallpossibleworlds", "worstofallpossibleworlds", "principle of sufficent reason",
    "sufficient reason", "hyperstitional", "handbook to the game", "the holy of holies", "the one great unit", "pseudo christos",
    "xenotation", "implextion", "ticxenotation", "barkerspiral", "dc barker", "professor dc barker", "geotraumatics", "mock turtle soup",
    "ticmaterial", "being of number", "being of beings", "padbbha", "yodtta", "ziltth", "wummno", "umneo", "tactt", "sigol", "rakht",
    "qush", "ohmega", "neom", "moan", "los", "kul", "ink", "jaeo", "hagg", "god", "cipher", "oldnick", "ahriman", "crypt",
    "cryptocurrents", "ibdhjad", "anglossic cycle", "worlds descent", "gateway of the gods", "ordinate number", "cardinal number",
    "programming with nothing", "gematria of nothing", "birth of the goddess", "hyperfunctional", "zero knowledge rollups", "zero knowledge",
    "zk rollups", "randomx", "controlled opposition", "breathing room", "four more years", "feels good man", "proof of work", "btc is not bitcoin",
    "craigwrightissatoshinakamoto", "satoshi", "tominaga nakamoto", "hash rate plutocracy", "xi jinping", "atomic swap", "atomic swaps",
